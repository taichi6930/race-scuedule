...
export class JraRaceEntity {
    ...
    constructor(
        ...
        public readonly location: JraRaceCourse, // 競馬場名
        public readonly surfaceType: JraRaceCourse, // 馬場種別
        public readonly distance: number, // 距離
        public readonly grade: JraGradeType, // グレード
    ...
    private generateId(
        ...
        return `jra${format(dateTime, 'yyyyMMdd')}${NETKEIBA_BABACODE[location]}${number.toXDigits(2)}`;
    }
